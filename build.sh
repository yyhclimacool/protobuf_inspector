...
function compile_protos() {
  CPP_DST_DIR=./proto_output/cpp_out
  JAVA_DST_DIR=./proto_output/java_out
  PYTHON_DST_DIR=./proto_output/python_out
  mkdir -p $CPP_DST_DIR
  mkdir -p $JAVA_DST_DIR
  mkdir -p $PYTHON_DST_DIR

  echo "Compiling protos..."
  protoc --proto_path=./proto --cpp_out=$CPP_DST_DIR --java_out=$JAVA_DST_DIR --python_out=$PYTHON_DST_DIR ./proto/*.proto
  echo "Compiling protos... Done."
}
